...
import { addMusicToVideo, copyFilesSync, createScreenshot, fileExists, makeHorizontalVideo, makeVerticalVideo, mergeVideosWithFFmpeg, putVideoOnVideo, resizeVideoBy6, speedUpVideo } from './utils';
  ...
  try {
    ...
    for (const [index, data] of trimDataList.entries()) {
      ...
      if (await fileExists(finalOutputPath)) {
        ...
        // const horizontalSpeededVideo = await speedUpVideo({
        //   inputPath: horizontalVideo,
        //   outputFolder,
        //   namePrefix: `${counter}_${customName}___HORIZONTAL___SPEEDUP`,
        //   speedFactor: 2.5,
        // });
        // horizontalSpeededVideos.push(horizontalSpeededVideo);
